...
pco <- read_qza(here("DEICODE","18S","ordination.qza"))
...
pco <- read_qza(here("DEICODE","12S","ordination.qza"))
...
combined_PCA_gg <- annotate_figure(ggarrange(ggarrange(ESP_CTD_12S_PCA, ESP_CTD_18S_PCA, 
                                            ...
                                            #  bottom = text_grob("PLACEHOLDER FOR 16S RESULTS", color = "red", rot = 45,
                                            # x = 0.25, y = 2.5, size = 30, face = "bold")
                                   )+
