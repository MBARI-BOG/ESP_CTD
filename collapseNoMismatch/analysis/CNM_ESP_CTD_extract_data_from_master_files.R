...
metadata_COI <- read.csv("/Users/markusmin/Documents/MBARI-2167/local/eDNA_meta_analysis_local_data/banzai_dada2/COI/for_MBON/raw_data/060420/COI_master_metadata.csv")
...
tax_table_COI <- read.csv("/Users/markusmin/Documents/MBARI-2167/local/eDNA_meta_analysis_local_data/banzai_dada2/COI/for_MBON/raw_data/060420/COI_master_tax_table.csv")
...
asv_table_COI <- read.csv("/Users/markusmin/Documents/MBARI-2167/local/eDNA_meta_analysis_local_data/banzai_dada2/COI/for_MBON/raw_data/collapseNoMismatch/COI_CNM_master_ASV_table.csv",row.names = 1)
# DESTROY X!!!
...
write.csv(ESP_CTD_COI_tax_table, here("collapseNoMismatch", "data", "COI", "CNM_ESP_CTD_COI_tax_table.csv"))

ESP_CTD_COI_asv_table <- as.data.frame(otu_table(ESP_CTD_COI_phyloseq))
write.csv(ESP_CTD_COI_asv_table, here("collapseNoMismatch", "data", "COI", "CNM_ESP_CTD_COI_asv_table.csv"))

ESP_CTD_COI_metadata <- as.data.frame(sample_data(ESP_CTD_COI_phyloseq))
write.csv(ESP_CTD_COI_metadata, here("collapseNoMismatch", "data", "COI", "CNM_ESP_CTD_COI_metadata.csv"))
...
### Prep metadata
# Load master metadata
metadata_18S <- read.csv("/Users/markusmin/Documents/MBARI-2167/local/eDNA_meta_analysis_local_data/banzai_dada2/18S/for_MBON/raw_data/062520/18S_master_metadata.csv")
...
tax_table_18S <- read.csv("/Users/markusmin/Documents/MBARI-2167/local/eDNA_meta_analysis_local_data/banzai_dada2/18S/for_MBON/raw_data/062520/18S_master_tax_table.csv")
...
# Load in master files
asv_table_18S <- read.csv("/Users/markusmin/Documents/MBARI-2167/local/eDNA_meta_analysis_local_data/banzai_dada2/18S/for_MBON/raw_data/collapseNoMismatch/18S_CNM_master_ASV_table.csv",row.names = 1)
# DESTROY X!!!
destroyX = function(es) {
  f = es
  for (col in c(1:ncol(f))){ #for each column in dataframe
...
write.csv(ESP_CTD_18S_tax_table, here("collapseNoMismatch", "data", "18S", "CNM_ESP_CTD_18S_tax_table.csv"))

ESP_CTD_18S_asv_table <- as.data.frame(otu_table(ESP_CTD_18S_phyloseq))
write.csv(ESP_CTD_18S_asv_table, here("collapseNoMismatch", "data", "18S", "CNM_ESP_CTD_18S_asv_table.csv"))

ESP_CTD_18S_metadata <- as.data.frame(sample_data(ESP_CTD_18S_phyloseq))
write.csv(ESP_CTD_18S_metadata, here("collapseNoMismatch", "data", "18S", "CNM_ESP_CTD_18S_metadata.csv"))
...
# Load master metadata
metadata_12S <- read.csv("/Users/markusmin/Documents/MBARI-2167/local/eDNA_meta_analysis_local_data/banzai_dada2/12S/for_MBON/raw_data/071620/12S_master_metadata.csv")
...
# Load in master files
asv_table_12S <- read.csv("/Users/markusmin/Documents/MBARI-2167/local/eDNA_meta_analysis_local_data/banzai_dada2/12S/for_MBON/raw_data/collapseNoMismatch/071620/12S_CNM_master_ASV_table.csv",row.names = 1)
# DESTROY X!!!
destroyX = function(es) {
  f = es
  for (col in c(1:ncol(f))){ #for each column in dataframe
...
tax_table_12S <- read.csv("/Users/markusmin/Documents/MBARI-2167/local/eDNA_meta_analysis_local_data/banzai_dada2/12S/for_MBON/raw_data/071620/12S_master_tax_table.csv",row.names = 1)
...
write.csv(ESP_CTD_12S_tax_table, here("collapseNoMismatch", "data", "12S", "CNM_ESP_CTD_12S_tax_table.csv"))

ESP_CTD_12S_asv_table <- as.data.frame(otu_table(ESP_CTD_12S_phyloseq))
write.csv(ESP_CTD_12S_asv_table, here("collapseNoMismatch", "data", "12S", "CNM_ESP_CTD_12S_asv_table.csv"))

ESP_CTD_12S_metadata <- as.data.frame(sample_data(ESP_CTD_12S_phyloseq))
write.csv(ESP_CTD_12S_metadata, here("collapseNoMismatch", "data", "12S", "CNM_ESP_CTD_12S_metadata.csv"))
...
write.csv(metadata_16S_ESP_CTD_subset, here("collapseNoMismatch", "data", "16S", "CNM_ESP_CTD_16S_metadata.csv"))
