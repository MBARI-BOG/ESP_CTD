...
distance_histogram <- function(input_data, variable){
  ...
  histogram <- ggplot(data = input_data, aes_string(x = "distance", fill = variable))+
    ...
    theme(panel.background = element_rect(fill ="white", color = "black"),
          ...
          plot.margin = unit(c(1.5,0.25,0,0), "cm"),
          legend.position = "none") +
...
combined_dist_hist <- egg::ggarrange(paired_histogram_16S, cruise_depth_histogram_16S,
                                     ...
                                     labels = c("(a) 16S", "", "(b) 18S", "", "(c) COI", "", "(d) 12S", "", "", ""),
                                                      label.args = list(gp=gpar(font=1, cex = 1.5), x=unit(0.25,"cm"), y=unit(5.6,"cm"), hjust = 0))
...
# Run this again, subsetting each cruise

# CN18S
paired_permutation_test(distance_metadata_df = subset(distances_metadata_16S, SAMPLING_cruise_1 == "CN18S" & SAMPLING_cruise_2 == "CN18S"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_18S, SAMPLING_cruise_1 == "CN18S" & SAMPLING_cruise_2 == "CN18S"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_COI, SAMPLING_cruise_1 == "CN18S" & SAMPLING_cruise_2 == "CN18S"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_12S, SAMPLING_cruise_1 == "CN18S" & SAMPLING_cruise_2 == "CN18S"), permutations = 1000)

# CN18F
paired_permutation_test(distance_metadata_df = subset(distances_metadata_16S, SAMPLING_cruise_1 == "CN18F" & SAMPLING_cruise_2 == "CN18F"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_18S, SAMPLING_cruise_1 == "CN18F" & SAMPLING_cruise_2 == "CN18F"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_COI, SAMPLING_cruise_1 == "CN18F" & SAMPLING_cruise_2 == "CN18F"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_12S, SAMPLING_cruise_1 == "CN18F" & SAMPLING_cruise_2 == "CN18F"), permutations = 1000)

# Shallow only
paired_permutation_test(distance_metadata_df = subset(distances_metadata_16S, depth_cat_1 == "Shallow" & depth_cat_2 == "Shallow"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_18S, depth_cat_1 == "Shallow" & depth_cat_2 == "Shallow"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_COI, depth_cat_1 == "Shallow" & depth_cat_2 == "Shallow"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_12S, depth_cat_1 == "Shallow" & depth_cat_2 == "Shallow"), permutations = 1000)

# Deep only
paired_permutation_test(distance_metadata_df = subset(distances_metadata_16S, depth_cat_1 == "Deep" & depth_cat_2 == "Deep"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_18S, depth_cat_1 == "Deep" & depth_cat_2 == "Deep"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_COI, depth_cat_1 == "Deep" & depth_cat_2 == "Deep"), permutations = 1000)
paired_permutation_test(distance_metadata_df = subset(distances_metadata_12S, depth_cat_1 == "Deep" & depth_cat_2 == "Deep"), permutations = 1000)
