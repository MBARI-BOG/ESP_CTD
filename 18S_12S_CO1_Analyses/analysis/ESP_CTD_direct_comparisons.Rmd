...
NOTE: This currently does not work because the ASV IDs from the samples are different because they're from different sequencing runs. So the PCA just has the two plates completely separate.
...
ESP_CTD_16S_directcomp_CN18FS_phyloseq <- merge_phyloseq(ESP_CTD_16S_envt_phyloseq, directcomp_16S_phyloseq)
```
