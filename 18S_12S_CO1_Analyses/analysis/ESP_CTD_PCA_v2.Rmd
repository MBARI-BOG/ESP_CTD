...
PCA_legend <- ggplot(pca_data) +
  ...
  annotate("text",label = "Peristaltic Pump", x = 0.6, y = -0.4,size = 7.5,adj = 0)+ #CTD
  annotate("point", x = 0.2, y = 0.4, shape = 23, colour = "black", fill = "black", size = 6, stroke = 3)+ # benchtop ESP
  annotate("text",label = "Benchtop ESP", x = 0.6, y = 0.4,size = 7.5,adj = 0)+ #ESP
  ...
  annotate("point", x = 8.9, y = 1.1, shape = 22, colour = "black", fill = "#1f78b4", size = 9, stroke = 2)+ # square point
  annotate("text",label = "Spring (shallow)", x = 9.25, y = 1.1,size = 7.5,adj = 0)+ # spring (shallow)
