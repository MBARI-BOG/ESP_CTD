...
ggsave(here(fig_dir, "Fig_S2_control_taxa_abs_reads.pdf"), control_abs_reads_comb_plot, height = 15, width = 24)
...
ggsave(here(fig_dir, "Fig_S2_control_taxa_rel_reads.pdf"), control_rel_reads_comb_plot, height = 15, width = 24)
