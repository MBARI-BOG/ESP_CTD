...
ESP_CTD_COI_phyloseq <- prune_samples(!(grepl("pre", sample_names(ESP_CTD_COI_phyloseq))), ESP_CTD_COI_phyloseq)
ESP_CTD_COI_phyloseq <- prune_samples(!(grepl("post", sample_names(ESP_CTD_COI_phyloseq))), ESP_CTD_COI_phyloseq)
ESP_CTD_COI_phyloseq <- prune_samples(!(grepl("pst", sample_names(ESP_CTD_COI_phyloseq))), ESP_CTD_COI_phyloseq)
...
# Remove pre and post blanks
ESP_CTD_18S_phyloseq <- prune_samples(!(grepl("pre", sample_names(ESP_CTD_18S_phyloseq))), ESP_CTD_18S_phyloseq)
ESP_CTD_18S_phyloseq <- prune_samples(!(grepl("post", sample_names(ESP_CTD_18S_phyloseq))), ESP_CTD_18S_phyloseq)
ESP_CTD_18S_phyloseq <- prune_samples(!(grepl("pst", sample_names(ESP_CTD_18S_phyloseq))), ESP_CTD_18S_phyloseq)
...
# Remove pre and post blanks
ESP_CTD_12S_phyloseq <- prune_samples(!(grepl("pre", sample_names(ESP_CTD_12S_phyloseq))), ESP_CTD_12S_phyloseq)
ESP_CTD_12S_phyloseq <- prune_samples(!(grepl("post", sample_names(ESP_CTD_12S_phyloseq))), ESP_CTD_12S_phyloseq)
ESP_CTD_12S_phyloseq <- prune_samples(!(grepl("pst", sample_names(ESP_CTD_12S_phyloseq))), ESP_CTD_12S_phyloseq)
...
# Remove pre and post blanks
ESP_CTD_16S_phyloseq <- prune_samples(!(grepl("pre", sample_names(ESP_CTD_16S_phyloseq))), ESP_CTD_16S_phyloseq)
ESP_CTD_16S_phyloseq <- prune_samples(!(grepl("post", sample_names(ESP_CTD_16S_phyloseq))), ESP_CTD_16S_phyloseq)
ESP_CTD_16S_phyloseq <- prune_samples(!(grepl("pst", sample_names(ESP_CTD_16S_phyloseq))), ESP_CTD_16S_phyloseq)
```
...
# blanks_metadata_COI %>% 
#   map_df(rev) -> blanks_metadata_COI
...
blanks_COI_table_forplot$phylum2 <- factor(blanks_COI_table_forplot$phylum2, levels = c("Arthropoda", "Ascomycota", "Bacillariophyta", "Chordata", "Cnidaria", "Gastrotricha", "Haptophyta",  "Ochrophyta", "Oomycota", "Picozoa", "Other", "Unassigned"))
...
blanks_COI_top_phyla_plot_rel_reads
...
blanks_COI_table_forplot_2$phylum2 <- factor(blanks_COI_table_forplot_2$phylum2, levels = c("Arthropoda", "Ascomycota", "Bacillariophyta", "Chordata", "Cnidaria", "Gastrotricha", "Haptophyta",  "Ochrophyta", "Oomycota", "Picozoa", "Other", "Unassigned"))
...
# Reverse order of data frame - this will help plot samples in right order, and also numbering of samples
# blanks_metadata_18S %>% 
#   map_df(rev) -> blanks_metadata_18S
...
# Reorder phyla so that unassigned and other are at the bottom
blanks_18S_table_forplot$phylum2 <- factor(blanks_18S_table_forplot$phylum2, levels = c("Arthropoda", "Bacillariophyta", "Basidiomycota", "Cercozoa", "Chordata", "Chytridiomycota", "Cnidaria", "Dinoflagellata", "Ochrophyta", "Streptophyta", "Other", "Unassigned"))
...
blanks_18S_top_phyla_plot_rel_reads
...
blanks_18S_table_forplot_2$phylum2 <- factor(blanks_18S_table_forplot_2$phylum2, levels = c("Arthropoda", "Bacillariophyta", "Basidiomycota", "Cercozoa", "Chordata", "Chytridiomycota", "Cnidaria", "Dinoflagellata", "Ochrophyta", "Streptophyta", "Other", "Unassigned"))
...
# Reverse order of data frame - this will help plot samples in right order, and also numbering of samples
# blanks_metadata_12S %>% 
#   map_df(rev) -> blanks_metadata_12S
...
blanks_12S_table_forplot$Family2 <- factor(blanks_12S_table_forplot$Family2, levels = c("Bovidae", "Canidae", "Clupeidae", "Engraulidae",     "Hominidae", "Merlucciidae", "Myctophidae", "Paralichthyidae", "Sciaenidae", "Sebastidae", "Other", "Unassigned"))
...
# Reorder families so that unassigned and other are at the bottom
blanks_12S_table_forplot_2$Family2 <- factor(blanks_12S_table_forplot_2$Family2, levels = c("Bovidae", "Canidae", "Clupeidae", "Engraulidae",     "Hominidae", "Merlucciidae", "Myctophidae", "Paralichthyidae", "Sciaenidae", "Sebastidae", "Other", "Unassigned"))
...
top10_phyla <- blanks_16S_phyla_reads$Phylum[1:10]
...
blanks_16S_table %>% 
  ...
  mutate(., Phylum = ifelse(Phylum %in% c("unassigned", "no_hit", "unknown"), "Unassigned", Phylum)) %>% 
  mutate(., phylum2 = ifelse(Phylum %in% top10_phyla | Phylum == "Unassigned", Phylum, "Other")) -> blanks_16S_table
